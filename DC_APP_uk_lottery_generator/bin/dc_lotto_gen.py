...
#File variables
    my_text_file = ("/opt/splunk/etc/apps/DC_APP_uk_lottery_generator/bin/lottery_gen.txt")
    my_log_file = ("/opt/splunk/etc/apps/DC_APP_uk_lottery_generator/bin/lottery_gen.log")
